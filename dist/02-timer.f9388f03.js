...
(0, _refs.startTimeButton).addEventListener("click", onStartTimeBtn);
(0, _refs.startTimeButton).disabled = true;
const timer = {
    intervalId: null,
...
(0, _flatpickrDefault.default)(".data-time", {
    enableTime: true,
    ...
    onChange: function(selectedDates, dateStr, instance) {
        ...
        if (now >= selected) {
            ...
            (0, _refs.startButton).disabled = true;
        } else {
            (0, _refs.startButton).disabled = false;
            timer.deadline = selected;
        }
    }
});

},{"flatpickr":"llQu5","./refs":"2WoF2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","flatpickr/dist/flatpickr.min.css":"eVN6V","notiflix":"5z0Oc","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
parcelHelpers.export(exports, "startTimeButton", ()=>startTimeButton);
// hw-1
const startButton = document.querySelector("[data-start]");
const stopButton = document.querySelector("[data-stop]");
// hw-2
const startTimeButton = document.querySelector("[data-start]");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eVN6V":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
