...
function onFormElem(event) {
    ...
    let delay1 = +event.currentTarget.elements.step.value;
    let amount = +event.currentTarget.elements.amount.value;
    for(let i = 0; i < amount; i++){
        let newdelay = firstdelay + delay1 * i;
        createPromise(newdelay, i + 1).then(({ delay , position  })=>{
...
},{"notiflix":"5z0Oc","notiflix/build/notiflix-notify-aio":"eXQLZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
