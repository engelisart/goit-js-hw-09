...
(0, _refs.startButton).addEventListener("click", onStartClick);
(0, _refs.stopButton).addEventListener("click", onStopClick);
(0, _refs.stopButton).disabled = true;
...
function onStartClick() {
    ...
    (0, _refs.stopButton).disabled = false;
}
